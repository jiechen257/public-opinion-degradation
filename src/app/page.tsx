    ...
    <main className="mx-auto flex min-h-screen w-full max-w-[1400px] flex-col gap-10 px-5 py-6 sm:px-8 lg:px-10">
      ...
      >
        <div className="space-y-6">
          <div className="flex flex-wrap gap-2 text-xs font-medium tracking-[0.18em] text-[color:var(--muted)] uppercase">
            <span className="border border-[color:var(--line)] px-3 py-1">
              今日样本
            </span>
            <span className="border border-[color:var(--line)] px-3 py-1">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <Link
              href="/experiments/demo"
              className="inline-flex min-h-11 items-center justify-center border border-[color:var(--rail)] bg-[color:var(--rail)] px-5 py-3 text-sm font-semibold tracking-[0.18em] text-[color:var(--paper)] uppercase transition hover:-translate-y-0.5 hover:bg-[color:var(--oxide)]"
            >
              开始观察双世界实验
            </Link>
        ...
        <aside className="grid gap-4 border-t border-[color:var(--line)] pt-5 lg:border-t-0 lg:border-l lg:pt-0 lg:pl-6">
          <div className="space-y-3 border border-[color:var(--line)] bg-[rgba(24,21,18,0.04)] p-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
              ...
              <div className="border-l-2 border-[color:var(--oxide)] pl-3">
                <p className="text-sm font-semibold">世界 B / 热度世界</p>
                <p className="mt-2 text-sm leading-7 text-[color:var(--muted)]">
                  姿态被奖励后，原问题只剩下表演价值。
                </p>
              </div>
          ...
          <div className="space-y-3 border border-[color:var(--line)] p-4">
            <p className="text-xs tracking-[0.2em] text-[color:var(--muted)] uppercase">
              三阶段轨迹
            </p>
      ...
      >
        <div className="space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <label className="space-y-2">
              ...
              <textarea
                readOnly
                value="该不该为了不被骂而先把所有立场话说满，再讨论具体问题？"
            ...
            <div className="grid gap-4">
              ...
              <div className="border border-[color:var(--line)] p-3">
                ...
                <div className="mt-3 flex gap-2 text-sm">
                  <span className="border border-[color:var(--rail)] bg-[color:var(--rail)] px-3 py-1 text-[color:var(--paper)]">
                    开
                  </span>
                  <span className="border border-[color:var(--line)] px-3 py-1 text-[color:var(--muted)]">
                    关
                  </span>
                </div>
              </div>
        ...
        <div className="grid gap-4 border-t border-[color:var(--line)] pt-5 lg:border-t-0 lg:border-l lg:pl-5 lg:pt-0">
